...
// Hardcoded SDG unified data (15 rows visible, showing first 10)
...
Critical challenges remain in economic empowerment, where the gender wage gap persists at 18% across comparable positions. The informal sector shows even greater disparities, with women earning 25% less than male counterparts. Addressing these gaps requires: (1) Pay transparency legislation, (2) Expanded access to business financing for women entrepreneurs, and (3) Strengthened enforcement of equal opportunity employment policies.`,
    narrativeRefined: `REFINED: Gender indicators show strong 6-year progress: GPI rose from 0.89 to 0.98, workforce participation up 11 points to 59%, and women in leadership increased to 34%. Key drivers: scholarships, childcare expansion, and flexible work policies. Remaining challenges include the 18% wage gap and underrepresentation in leadership. Priority: pay transparency legislation and financing access for women entrepreneurs.`,
  },
  {
    id: "climate",
